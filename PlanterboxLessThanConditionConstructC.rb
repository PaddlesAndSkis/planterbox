# PlanterboxLessThanConditionConstructC.rb

require_relative "PlanterboxConditionConstructA.rb"

class PlanterboxLessThanConditionConstructC < PlanterboxConditionConstructA
    ...
    def evaluate(dataDictionary, conditionHash)
        ...
        begin
            ...
            puts "In Less Than with myKey = #{myKey} and myValue = #{myValue}"

            dataDictionaryValue = dataDictionary[myKey]
            puts "In Less Than with dataDictionaryValue = #{dataDictionaryValue}"
            ...
            if dataDictionaryValue != nil
                ...
                if myValueInt != nil
                    ...
                    # string
                    # If Turner lessThan Cam

                    origArray = [dataDictionaryValue, myValue]
                    sortArray = origArray.sort
